...
import 'package:ver_0_1/widgets/models/bank_account.dart';
import 'package:ver_0_1/widgets/models/card_account.dart';
import 'package:ver_0_1/widgets/models/money_transaction.dart';
import 'package:ver_0_1/widgets/models/transaction_category.dart';
import 'package:ver_0_1/widgets/models/expiration_investment.dart';
import 'package:ver_0_1/widgets/models/nonexpiration_investment.dart';
import 'package:ver_0_1/widgets/models/current_holdings.dart';
import 'package:ver_0_1/widgets/models/budget_setting.dart';
import 'package:ver_0_1/widgets/models/extra_budget_group.dart';
...
/// 카테고리
  ...
  Future<void> _insertDefaultCategories(Database db) async {
    Map<String, List<String>> defaultCategories = {
      "수입": ["급여소득", "용돈", "금융소득"],
      "소비": ["식비", "외식비", "주거비", "통신비", "생활비", "미용비", "의료비", "문화비", "유흥*모임비", "교통비", "세금", "금융비용", "보험", "기타", '특별 예산'],
