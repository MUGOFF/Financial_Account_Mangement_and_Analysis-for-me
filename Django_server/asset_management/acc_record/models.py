...
class Transaction(models.Model):
    ...
    transaction_from = models.ForeignKey(Financialaccount,on_delete=models.CASCADE,blank=True,null=True)
    ...
    category_hooked = models.ForeignKey('Flow_category',on_delete=models.CASCADE,blank=True,null=True)
    description = models.TextField(blank=True)
    
    def __str__(self):
        return self.transaction_time +'from' + transaction_from + 'to' + self.transaction_to_nickname
#항목 통합
